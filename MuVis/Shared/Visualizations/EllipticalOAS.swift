...
///
/// Created by Keith Bromley on 21 Feb 2021 (adapted from his previous java version in the Polaris app). Animated in Aug 2022.
...
struct EllipticalOAS_Live: View {
    ...
    var body: some View {
        ...
        ForEach( 0 ..< octaveCount, id: \.self) { octave in        //  0 <= octave < 8
            ...
            EllipticalOAS_Live_Shape(vector: spectrumA, oct: octave)
...
struct EllipticalOAS_Live_Shape: Shape {
...
} // end of EllipticalOAS_Live_Shape struct
