...
struct LavaLamp: View {
    ...
    func updateParameters() {
        ...
        for oct in 0 ..< 6 {
            octEnergy[oct] = 0.0
            for peakNum in 0 ..< AudioManager.peakCount {                                   // peakCount = 16
                if (audioManager.peakBinNumbers[peakNum] >= settings.octBottomBin[oct] &&
                    audioManager.peakBinNumbers[peakNum] <= settings.octTopBin[oct]) {
