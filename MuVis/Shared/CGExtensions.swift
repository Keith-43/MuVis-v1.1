...
//  Spontanea
//
// These are some useful extensions to some Core Graphics vector operations. They are used in the MorphingCircle() and MorphingCircleShape() structs within this MorphingShapes project.
//
